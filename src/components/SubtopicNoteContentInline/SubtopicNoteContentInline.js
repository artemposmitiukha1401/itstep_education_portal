...
export default function SubtopicNoteContentInline({
    subjectId,
    topicId,
    subtopicId,
    scale,
    ...
    return (
        <div
            className="SubtopicNoteContentInline"
            style={{ "--content-scale": scale }}
        >
            {note.text && (
...
<Link
    className="subtopicTestBtn"
    to={`/subject/${subjectId}/topic/${topicId}/quiz`}
>
    <span className="subtopicTestBtnText">Пройти тест</span>

    <svg
        className="subtopicTestBtnIcon"
        width="100%"
        height="100%"
        viewBox="0 0 24 24"
        fill="none"
